...
class SlowFast(nn.Module):
    def __init__(self, block=Bottleneck, layers=[3, 4, 6, 3], class_num=10, dropout=0.5):
        ...
        self.pool1 = nn.MaxPool3d(kernel_size=(TIME_SCALE[0], 1, 1), stride=(TIME_SCALE[0], 1, 1))
        self.pool2 = nn.MaxPool3d(kernel_size=(TIME_SCALE[1], 1, 1), stride=(TIME_SCALE[1], 1, 1))
